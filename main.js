...
const PrintRepoCardsWithSearchBar = () => {
  ...
  let repoCardsWithSearchBar = `
				<div><input id="repoSearchbar" onkeyup="searchRepos" type="text" name="search" placeholder="Find a repository..."
						...
						<div class="card overview-card" id="${card.repoID}">
							<div class="card-body text-white bg-dark" id="overview-card-body">
								<div class="container d-flex justify-content-between">
									...
									<button type="button" class="btn btn-danger btn-sm" style="width: 7em; height: 3em">
